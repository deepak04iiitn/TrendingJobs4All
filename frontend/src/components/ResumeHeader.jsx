...
import { Plus, Filter, Sparkles, FileText } from 'lucide-react';

const ResumeHeader = ({ onFilterClick, onShareClick }) => {
  return (
        ...
        <div className="relative bg-white/80 backdrop-blur-xl border border-white/50 rounded-3xl shadow-xl shadow-indigo-100/50 p-8">
          ...
          <div className="text-center mb-8">
            ...
            <div className="flex items-center justify-center gap-2 mt-4">
              ...
              <span className="text-sm text-gray-500 ml-2">Boost your job hunt with proven formats</span>
            </div>
          </div>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
            ...
            >
              ...
              <div className="relative px-10 py-4 bg-gradient-to-r from-indigo-600 to-purple-600 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 flex items-center justify-center gap-3">
            ...
            >
              ...
              <div className="relative px-10 py-4 bg-gradient-to-r from-emerald-600 to-teal-600 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 flex items-center justify-center gap-3">
                <div className="w-10 h-10 bg-white/20 rounded-xl flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
                  <Plus className="w-5 h-5 text-white" />
                </div>
                <div className="text-left">
                  <div className="font-semibold text-white">Share Resume</div>

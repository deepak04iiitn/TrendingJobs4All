      ...
      <div className="relative overflow-hidden rounded-3xl bg-gradient-to-r from-indigo-600 via-purple-500 to-pink-500 p-1">
        ...
        <div className="relative bg-white/95 rounded-[1.4rem] px-8 py-6">
          ...
          <div className="text-center mb-8">
            ...
            "Find and share winning resume templates on TrendingJobs4All, tailored for specific companies, roles, and experience levels. 
            Sort templates by company, position, or years of experience to craft a standout application. 
            Boost your job hunt with proven formats!"
            </p>
          </div>

...
import ReferralComment from "../models/referralComment.model.js";

export const createComment = async(req , res , next) => {

    try {
        
        const { content , refId , userId } = req.body;
        ...
        const newComment = new ReferralComment({
            content,
            userId,
            refId,
        });
...
export const getComments = async(req , res , next) => {
    ...
    try {
        ...
        const comments = await ReferralComment.find({ refId : req.params.refId }).sort({
...
export const likeComment = async(req , res , next) => {
    ...
    try {
        ...
        const comment = await ReferralComment.findById(req.params.commentId);
...
export const editComment = async(req , res , next) => {
    ...
    try {
        ...
        const editedComment = await ReferralComment.findByIdAndUpdate(
...
export const deleteComment = async (req, res, next) => {
    ...
    try {
      ...
      await ReferralComment.findByIdAndDelete(req.params.commentId);

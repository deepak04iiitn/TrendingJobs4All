...
import { createSalary, deleteSal, dislikeSalary, getsalary, getSalaryById, likeSalary } from '../controllers/salary.controller.js';

const router = express.Router();

router.post('/createSalary' , verifyToken , createSalary);
router.get('/getSalary' , getsalary);
router.get('/getSalary/:salId', getSalaryById);
